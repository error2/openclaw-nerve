...
- New env var `NERVE_WATCHER_MAX_LIFETIME_MS` to tune the watcher lifetime cap (default 3600000 = 60 minutes). Long-running autonomous tasks should set this higher.
